...
def parse_arguments(camera_width, camera_height, path_to_video, path_to_output_video, color):
	# argument parsing
...
COLOR = "yellow"
#parse_arguments(CAMERA_WIDTH, CAMERA_HEIGHT, PATH_TO_VIDEO, PATH_TO_OUTPUT_VIDEO, COLOR)
...
# read encouragement sentences from file
